...
клиента, хранящего сообщения чата и основные действия приложения. Устанавливает имя клиента для чата.
...
2. При получении сообщений от сервера сохраняет их в файл клиентского лога, а так же выводит
их в консоль клиентского приложения.
...
#### Обработчик клиент(ClientHandler) выполняет следующие задачи:
